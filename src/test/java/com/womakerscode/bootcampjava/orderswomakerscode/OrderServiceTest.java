...
import com.womakerscode.bootcampjava.orderswomakerscode.repository.OrderRepository;
import com.womakerscode.bootcampjava.orderswomakerscode.service.OrderService;
...
public class OrderServiceTest {
    ...
    private final Order orderMock = OrderServiceMock.order();

    @BeforeEach
    public void setUp() {

        BDDMockito.when(orderRepository.save(OrderServiceMock.order()))
    ...
    public void shouldCreateAnOrderSuccessfully() {
        Order orderToBeSaved = OrderServiceMock.order();
